...
namespace XtremeIdiots.Portal.RepositoryApiClient.Api
{
    ...
    {
        public RecentPlayersApi(ILogger<RecentPlayersApi> logger, IApiTokenProvider apiTokenProvider, IOptions<RepositoryApiClientOptions> options) : base(logger, apiTokenProvider, options)
        {
        }
