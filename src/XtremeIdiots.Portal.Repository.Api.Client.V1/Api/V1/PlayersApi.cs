...
namespace XtremeIdiots.Portal.Repository.Api.Client.V1
{
    public class PlayersApi : BaseApi<RepositoryApiClientOptions>, IPlayersApi
    {
        ...
        {
            var request = await CreateRequestAsync($"v1/players/{playerId}", Method.Get).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/by-game-type/{gameType}/{guid}", Method.Head).ConfigureAwait(false);
            var response = await ExecuteAsync(request).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/by-game-type/{gameType}/{guid}", Method.Get).ConfigureAwait(false);
            request.AddQueryParameter(nameof(playerEntityOptions), playerEntityOptions);
        ...
        {
            var request = await CreateRequestAsync("v1/players", Method.Get).ConfigureAwait(false);
            request.AddQueryParameter(nameof(playerEntityOptions), playerEntityOptions);
        ...
        {
            var request = await CreateRequestAsync("v1/players/with-ip-address", Method.Get).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/protected-names/{protectedNameId}", Method.Get).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/{playerId}/protected-names", Method.Get).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync("v1/players/protected-names", Method.Post).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/protected-names/{deleteProtectedNameDto.ProtectedNameId}", Method.Delete).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/protected-names/{protectedNameId}/usage-report", Method.Get).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/{playerId}/tags", Method.Get).ConfigureAwait(false);
            var response = await ExecuteAsync(request).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/{playerId}/ip-addresses", Method.Get).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/{playerId}/tags", Method.Post).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/{playerId}/tags/{playerTagId}", Method.Delete).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/tags/{playerTagId}", Method.Get).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/tags/{playerTagId}", Method.Delete).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/{playerId}/aliases", Method.Get).ConfigureAwait(false);
            request.AddQueryParameter(nameof(skipEntries), skipEntries);
            request.AddQueryParameter(nameof(takeEntries), takeEntries);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/{playerId}/aliases", Method.Post).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/{playerId}/aliases/{aliasId}", Method.Patch).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/players/{playerId}/aliases/{aliasId}", Method.Delete).ConfigureAwait(false);
        ...
        {
            var request = await CreateRequestAsync($"v1/aliases/search", Method.Get).ConfigureAwait(false);
