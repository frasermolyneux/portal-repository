...
├── .AdminActions      (IVersionedAdminActionsApi)
├── .BanFileMonitors   (IVersionedBanFileMonitorsApi)
├── .ChatMessages      (IVersionedChatMessagesApi)
├── .Demos             (IVersionedDemosApi)
├── .GameServers       (IVersionedGameServersApi)
...
├── .UserProfiles      (IVersionedUserProfileApi)
